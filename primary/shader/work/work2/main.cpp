...
"void main()\n"
"{\n"
"   gl_Position = vec4(aPos.x + myoffset.x,aPos.y + myoffset.y,aPos.z + myoffset.z, 1.0);\n"
"}\0";
...
"void main()\n"
"{\n"
"    FlagColor = vec4(1.0f,0.2f,0.3f,1.0f);\n"
"}\0";
...
int main()
{
	...
	int vertexColorLocation = glGetUniformLocation(ShaderProgram, "myoffset");
	glUseProgram(ShaderProgram);
	glUniform3f(vertexColorLocation, 0.4f, 0.0f, 0.0f);
